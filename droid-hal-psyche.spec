...
%define makefstab_skip_entries /vendor-firmware_mnt /vendor-dsp /vendor-bt_firmware /metadata /odm /product /system /system_ext /vendor /dev/stune /dev/cpuset /sys/fs/pstore /dev/cpuctl
